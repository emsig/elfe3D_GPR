!> \file mod_read_mesh.f90
!> \brief Module of elfe3d containing subroutines to read TetGen ASCII meshes
!> \details Reads node, edge, element, and neighbor files generated by TetGen and
!> \details produces internal mesh arrays used by the finite-element assembly routines.
!!
...
contains
  ...
  !---------------------------------------------------------------------
  !> \brief Read a TetGen .node file and allocate node coordinate arrays
  !> \param[in] FileName Name of the TetGen .node file
  !> \param[out] N Number of nodes read from the file
  !> \param[out] nd Node coordinate array of size (N,3)
  !> \param[out] nodemarker Boundary marker array for each node
  !---------------------------------------------------------------------
  ...
  !---------------------------------------------------------------------
  !> \brief Read a TetGen .edge file and allocate edge connectivity arrays
  !> \param[in] FileName Name of the TetGen .edge file
  !> \param[out] E Number of edges read from the file
  !> \param[out] ed2nd Edge node connectivity array of size (E,2)
  !> \param[out] edgemarker Boundary marker array for each edge
  !---------------------------------------------------------------------
  ...
  !---------------------------------------------------------------------
  !> \brief Read a TetGen .ele file and allocate element node and attribute arrays
  !> \param[in] FileName Name of the TetGen .ele file
  !> \param[out] M Number of elements read from the file
  !> \param[out] el2nd Element-to-node connectivity array of size (M,4)
  !> \param[out] eleattr Element attribute array of length M
  !---------------------------------------------------------------------
  ...
  !---------------------------------------------------------------------
  !> \brief Read a TetGen .neigh file and allocate neighbor element mapping
  !> \param[in] FileName Name of the TetGen .neigh file
  !> \param[in] M Number of elements expected in the .neigh file
  !> \param[out] el2neigh Neighbor mapping array of size (M,4)
  !---------------------------------------------------------------------
