...
class elfe3DGPRTestDesign:
    ...
    def __init__(
        ...
        self.receiver_antenna['inline_x'] = [round(0.2 + i * (2.0 - 0.2) / (self.receiver_antenna['num_receivers_inline'] - 1), 5) for i in range(self.receiver_antenna['num_receivers_inline'])]
        ...
        self.receiver_antenna['endfire_y'] = [round(0.2 + i * (2.0 - 0.2) / (self.receiver_antenna['num_receivers_endfire'] - 1), 5) for i in range(self.receiver_antenna['num_receivers_endfire'])]
