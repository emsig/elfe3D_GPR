...
class elfe3DGPRTestDesign:
    ...
    def __init__(
        ...
        self.regions['largest_wavelengths'] = self.regions['central_wavelengths']
        
        # Calculate max element edges and volumes
        self.regions['max_element_edges'] = (np.array(self.regions['central_wavelengths']) / self.least_samples_per_wavelength).tolist()
