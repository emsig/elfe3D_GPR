...
class elfe3DGPRTestDesign:
    ...
    def __init__(
        ...
        x_e=[], y_e=[], z_e=[], experiment_name="test", m=4, box_x=4.8 , s_f=50, box_present=True,
):
        self.c = 3e8
        ...
        self.source_antenna['box_x'] = [[self.source_antenna['antenna_position'][0] - self.regions['largest_wavelengths'][0] / 4,
                                         box_x if num_layers == 0 else box_x[0]]]
                                        #  self.source_antenna['antenna_position'][0] + self.regions['largest_wavelengths'][0] / 4]]
        self.source_antenna['box_y'] = [[self.source_antenna['antenna_position'][1] - self.regions['largest_wavelengths'][0] / 4,
                                         self.source_antenna['antenna_position'][1] + self.regions['largest_wavelengths'][0] / 4]]
        self.source_antenna['box_z'] = [[self.source_antenna['antenna_position'][2] + self.regions['largest_wavelengths'][0] / 4, 0.0]]
        ...
        if num_layers > 0:
            ...
            self.source_antenna['box_y'].append(
                [self.source_antenna['antenna_position'][1] - self.regions['largest_wavelengths'][1] / 4,
                                         self.source_antenna['antenna_position'][1] + self.regions['largest_wavelengths'][1] / 4]
            )
            self.source_antenna['box_z'].append(
                [0.0, self.source_antenna['antenna_position'][2] - self.regions['largest_wavelengths'][1] / 4]
            )
        else:
            self.source_antenna['box_x'].append(
                [self.source_antenna['antenna_position'][0] - self.regions['largest_wavelengths'][0] / 4,
            ...
            self.source_antenna['box_z'].append(
                [0.0, self.source_antenna['antenna_position'][2] - self.regions['largest_wavelengths'][0] / 4]
            )
        ...
        self.receiver_antenna['inline_x'] = [round(0.2 + i * (self.domain['x_max'] - 0.4) / (self.receiver_antenna['num_receivers_inline'] - 1), 4) for i in range(self.receiver_antenna['num_receivers_inline'])]
        ...
        self.receiver_antenna['endfire_y'] = [round(0.2 + i * (self.domain['y_max'] - 0.4) / (self.receiver_antenna['num_receivers_endfire'] - 1), 4) for i in range(self.receiver_antenna['num_receivers_endfire'])]
        ...
        self.receiver_antenna['oblique_x'] = [round(x * np.cos(np.pi / 4), 4) for x in self.receiver_antenna['inline_x']] if self.receiver_antenna['num_receivers_oblique'] > 0 else []
        self.receiver_antenna['oblique_y'] = [round(x * np.sin(np.pi / 4), 4) for x in self.receiver_antenna['inline_x']] if self.receiver_antenna['num_receivers_oblique'] > 0 else []
