...
class elfe3DGPRTestDesign:
    ...
    def __init__(
        ...
        self.source_antenna['x_extents'] = [self.source_antenna['antenna_coordinates'][0][0], self.source_antenna['antenna_coordinates'][1][0]]
        self.source_antenna['y_extents'] = [self.source_antenna['antenna_coordinates'][0][1], self.source_antenna['antenna_coordinates'][1][1]]
        self.source_antenna['z_extents'] = [self.source_antenna['antenna_coordinates'][0][2], self.source_antenna['antenna_coordinates'][1][2]]
