...
class elfe3DGPRTestDesign:
    ...
    def __init__(
        ...
        x_e=[], y_e=[], z_e=[], experiment_name="test", m=4, box_x=4.8 , s_f=50, box_present=True, bh_f=1.0,
                anomaly_coordinates=None, anomaly_properties=None,
):
        self.c = 3e8
        ...
        self.anomaly = {
                    'x': anomaly_coordinates[0],
                    'y': anomaly_coordinates[1],
                    'z': anomaly_coordinates[2],
        ...
        # Place inline receivers between 1.0 and 4.0 with spacing of 0.02 m
