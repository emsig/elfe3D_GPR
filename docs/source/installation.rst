...
The Python I/O layer is implemented in the `io/` folder and packaged under the namespace `elfe3d_gpr_io`.
...
The supported import namespace is (package installed as `elfe3d_gpr_io`):
