...
- how to define surveys with the `elfe3d_gpr_io` Python I/O wrapper
...
The notebooks now use the installed package namespace `elfe3d_gpr_io`, so they work cleanly after `pip install -e .`.
